                            ...
                            <div class="col-lg-12">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" autocomplete="off" name="title" class="form-control" value="{{$banner->title}}"
                                    ...
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" autocomplete="off" name="subtitle" value="{{$banner->subtitle}}" class="form-control" 
